...
class YoutubeService:
    ...
    def __init__(self, client_secret, scopes=None, api_service_name=None, api_version=None, port=8081):
        """
        ...
        try:
            ...
            try:
                ...
                if "Address already in use" in str(e) or "WinError 10048" in str(e) or "WinError 10013" in str(e):
                    logger.warning(f"Port {self.port} is occupied, trying port {self.port + 1}")
